    ...
    ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
  ...
  protected void addKeyPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_ProductToProductVersionMapEntry_key_feature"),
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_ProductToProductVersionMapEntry_value_feature"),
  ...
  {
    Map.Entry<?, ?> productToProductVersionMapEntry = (Map.Entry<?, ?>)object;
    return "" + productToProductVersionMapEntry.getKey() + " -> " + productToProductVersionMapEntry.getValue();
  }
