 ...
 * @generated
 */
public class WorkingSetsItemProviderAdapterFactory extends WorkingSetsAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable
{
  /**
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.eclipse.oomph.workingsets.WorkingSet} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.eclipse.oomph.workingsets.WorkingSet}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.eclipse.oomph.workingsets.WorkingSetGroup} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.eclipse.oomph.workingsets.WorkingSetGroup}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.eclipse.oomph.workingsets.ExclusionPredicate} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.eclipse.oomph.workingsets.ExclusionPredicate}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.eclipse.oomph.workingsets.InclusionPredicate} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.eclipse.oomph.workingsets.InclusionPredicate}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public static class PredicatesChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends PredicatesSwitch<Object>
    {
      ...
      {
        newChildDescriptors
            .add(createChildParameter(PredicatesPackage.Literals.OR_PREDICATE__OPERANDS, WorkingSetsFactory.eINSTANCE.createInclusionPredicate()));

        newChildDescriptors
            .add(createChildParameter(PredicatesPackage.Literals.OR_PREDICATE__OPERANDS, WorkingSetsFactory.eINSTANCE.createExclusionPredicate()));
      ...
      {
        newChildDescriptors
            .add(createChildParameter(PredicatesPackage.Literals.NOT_PREDICATE__OPERAND, WorkingSetsFactory.eINSTANCE.createInclusionPredicate()));

        newChildDescriptors
            .add(createChildParameter(PredicatesPackage.Literals.NOT_PREDICATE__OPERAND, WorkingSetsFactory.eINSTANCE.createExclusionPredicate()));
  ...
  public static class BaseChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends BaseSwitch<Object>
    {
      ...
      {
        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, WorkingSetsFactory.eINSTANCE.createWorkingSet()));

        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, WorkingSetsFactory.eINSTANCE.createWorkingSetGroup()));

        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, WorkingSetsFactory.eINSTANCE.createInclusionPredicate()));

        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, WorkingSetsFactory.eINSTANCE.createExclusionPredicate()));
