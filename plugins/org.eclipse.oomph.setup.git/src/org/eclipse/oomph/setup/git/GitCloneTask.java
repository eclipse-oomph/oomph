...
public interface GitCloneTask extends SetupTask
{
   ...
   *        annotation="http://www.eclipse.org/oomph/setup/RuleVariable name='git.container.root' type='FOLDER' label='Root Git-container folder' defaultValue='${user.home/git}' description='The root Git-container folder where all the Git clones are located' storageURI='scope://'"
   * @generated
   */
  String getLocation();
