...
public class JDTPackageImpl extends EPackageImpl implements JDTPackage
{
  ...
  protected void createVariableAnnotations()
  {
    ...
    addAnnotation(jreTaskEClass, new boolean[] { true }, "Choice", //$NON-NLS-1$
        new String[] { "value", "${jre.location-27}", //$NON-NLS-1$ //$NON-NLS-2$
            "label", "JRE 27 Location" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(jreTaskEClass, new boolean[] { true }, "Choice", //$NON-NLS-1$
        new String[] { "value", "${jre.location-28}", //$NON-NLS-1$ //$NON-NLS-2$
            "label", "JRE 28 Location" //$NON-NLS-1$ //$NON-NLS-2$
        });
    ...
    addAnnotation(jreTaskEClass, source, new String[] { "name", "jre.location-27", //$NON-NLS-1$ //$NON-NLS-2$
        "type", "JRE", //$NON-NLS-1$ //$NON-NLS-2$
        "label", "JRE 27 Location", //$NON-NLS-1$ //$NON-NLS-2$
        "description", "The location of a JDK or JRE compatible with Java 27.", //$NON-NLS-1$ //$NON-NLS-2$
        "version", "JavaSE-27" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(jreTaskEClass, new boolean[] { true }, "Choice", //$NON-NLS-1$
        new String[] { "value", "${jre.location-28}", //$NON-NLS-1$ //$NON-NLS-2$
            "label", "JRE 28 Location" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(jreTaskEClass, source, new String[] { "name", "jre.location-28", //$NON-NLS-1$ //$NON-NLS-2$
        "type", "JRE", //$NON-NLS-1$ //$NON-NLS-2$
        "label", "JRE 28 Location", //$NON-NLS-1$ //$NON-NLS-2$
        "description", "The location of a JDK or JRE compatible with Java 28.", //$NON-NLS-1$ //$NON-NLS-2$
        "version", "JavaSE-28" //$NON-NLS-1$ //$NON-NLS-2$
    });
  }
