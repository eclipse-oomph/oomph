...
public class LaunchingAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected LaunchingSwitch<Adapter> modelSwitch = new LaunchingSwitch<Adapter>()
  {
    ...
    {
      return createLaunchTaskAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.oomph.setup.launching.LaunchTask <em>Launch Task</em>}'.
   * <!-- begin-user-doc -->
