...
public class ProjectsPackageImpl extends EPackageImpl implements ProjectsPackage
{
  ...
  protected void createEcoreAnnotations()
  {
    ...
    addAnnotation(this, source, new String[] { "schemaLocation", "https://raw.githubusercontent.com/eclipse-oomph/oomph/master/setups/models/Projects.ecore" //$NON-NLS-1$ //$NON-NLS-2$
    });
  }
  ...
  protected void createLabelProviderAnnotations()
  {
    ...
    addAnnotation(this, source, new String[] { "imageBaseURI", //$NON-NLS-1$
        "https://raw.githubusercontent.com/eclipse-oomph/oomph/master/plugins/org.eclipse.oomph.setup.projects.edit/icons/full/obj16" //$NON-NLS-1$
    });
  }
