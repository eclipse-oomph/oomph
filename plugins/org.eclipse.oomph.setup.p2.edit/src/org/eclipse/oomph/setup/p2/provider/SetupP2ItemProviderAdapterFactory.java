...
import org.eclipse.oomph.setup.p2.util.SetupP2AdapterFactory;
 ...
 * @generated
 */
public class SetupP2ItemProviderAdapterFactory extends SetupP2AdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable
{
  /**
   ...
   * @generated
   */
  public SetupP2ItemProviderAdapterFactory()
  {
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.eclipse.oomph.setup.p2.P2Task} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.eclipse.oomph.setup.p2.P2Task}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public static class BaseChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends BaseSwitch<Object>
    {
      ...
      {
        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, SetupP2Factory.eINSTANCE.createP2Task()));
  ...
  public static class SetupChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends SetupSwitch<Object>
    {
      ...
      {
        newChildDescriptors.add(createChildParameter(SetupPackage.Literals.SETUP_TASK_CONTAINER__SETUP_TASKS, SetupP2Factory.eINSTANCE.createP2Task()));
