...
cp -a "$WORKSPACE/git/products/org.eclipse.oomph.setup.installer.product/target/products/*.zip" "$WORKSPACE/products"
cp -a "$WORKSPACE/git/products/org.eclipse.oomph.setup.installer.product/target/products/*.tar.gz" "$WORKSPACE/products"
